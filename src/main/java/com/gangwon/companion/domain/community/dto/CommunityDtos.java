...
public final class CommunityDtos {
    ...
    public record PostSummary(Long id, String title, String author, boolean isMine, boolean liked, boolean saved, int viewCount, int likeCount, long saveCount, int imageCount, Long courseId, Set<String> hashtags, LocalDateTime createdAt) {}
    public record CommentResponse(Long id, String author, String content, int likeCount, boolean liked, boolean isMine, LocalDateTime createdAt) {}
    public record PostDetail(Long id, String title, String content, String author, boolean isMine, boolean liked, boolean saved, int viewCount, int likeCount, long saveCount, Long courseId, Set<String> hashtags, LocalDateTime createdAt, LocalDateTime updatedAt, List<ImageResponse> images, List<CommentResponse> comments) {}
