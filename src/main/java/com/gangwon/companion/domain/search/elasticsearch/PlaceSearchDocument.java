...
public record PlaceSearchDocument(
        ...
        String themeName, String menuType, String placeSubtype, Double rating, Long price, String petInfoText,
    ...
    public PlaceSearchDocument(
        ...
        this(placeId, domain, name, address, regionCode, searchText, location, petAllowed,
                ...
                themeName, menuType, placeSubtype, rating, price, petInfoText, accessibilityInfoText,
